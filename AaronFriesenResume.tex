...
{Cumulative GPA: 3.16}
	\area{Computer Science}{ Intro to Object Oriented Programming $\cdot$ Data Structures and Algorithms Computer Organization and Programming $\cdot$ Objects and Design $\cdot$ Computer Graphics \newline Intro to Artificial Intelligence $\cdot$ User Interface Design $\cdot$ Computer Audio $\cdot$ Game AI}
